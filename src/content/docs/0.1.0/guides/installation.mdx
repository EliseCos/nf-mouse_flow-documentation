---
title: Installation
description: How to install nf-mouse
...
<Steps>
  ...
  2. **Docker OR Apptainer**
     ...
     In order to avoid users installing all software dependencies used within `nf-mouse`, the pipeline relies on containers for all processing steps. Those containers can be run using two technologies: **Docker** or **Apptainer**.
...
Once everything installed and/or available, you can proceed to the [inputs section](/nf-mouse/0.1.0/guides/inputs).
