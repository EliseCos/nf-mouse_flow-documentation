---
title: Running nf-mouse without internet access
description: How to run nf-mouse with no internet access
---
...
<Steps>
  ...
  4. Run the `nf-core pipelines download`
     ...
     <CommandOutputs>
       <span slot="command">
         ```bash
         nf-core pipelines download scilus/nf-mouse -r 0.1.0 -o ./containers/ -s singularity -l docker.io -u copy --force
         ```
       </span>
...
Now you are good to go! Please refer to the [usage documentation on how to launch the pipeline](/nf-mouse/guides/usage).